...
export class Ormconfigts1724430760365 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`artist_albums\` (\`albumId\` int NOT NULL, \`artistEntityId\` int NOT NULL, INDEX \`IDX_8e83c54cd9c53f2abb85213c7d\` (\`albumId\`), INDEX \`IDX_841bc9dbb03f0ee0301a8abb79\` (\`artistEntityId\`), PRIMARY KEY (\`albumId\`, \`artistEntityId\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
